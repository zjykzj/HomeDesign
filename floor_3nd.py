...
# 其他走廊：剩余部分
ax.add_patch(patches.Rectangle((2 + wall_thickness, 6.5 - wall_thickness), 3, 1.5,
...
# 客厅卫生间：位于次卧上方
draw_wall(0, 5 - wall_thickness, 2 + wall_thickness, 4 + wall_thickness)
ax.add_patch(
    patches.Rectangle((wall_thickness, 5), 2 - wall_thickness, 4 - wall_thickness,
